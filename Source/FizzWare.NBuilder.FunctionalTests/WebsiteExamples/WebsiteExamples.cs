...
namespace FizzWare.NBuilder.FunctionalTests.WebsiteExamples
{
    ...
    public class WebsiteExamples
    {
        ...
        public void Persistence_1_and_2()
        {
            ...
            builderSettings.SetCreatePersistenceMethod<Model.Product>(productRepository.Create);
            builderSettings.SetCreatePersistenceMethod<IList<Model.Product>>(productRepository.CreateAll);
