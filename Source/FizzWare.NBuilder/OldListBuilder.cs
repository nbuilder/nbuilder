...
//        public ListBuilder(int size, INamingStrategy<T> namingStategy)
//        {
...
//            namingStategy.SetValuesOfAllIn(builtObjects.ToList());
//        }

//        public ListBuilder(int size, INamingStrategy<T> namingStategy, params object[] args)
//        {
//            for (int i = 0; i < size; i++)
//            {
