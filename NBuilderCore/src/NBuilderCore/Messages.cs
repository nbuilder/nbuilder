namespace NBuilderCore
{
    ...
    {
        internal const string NewSyntax_UseTheFirst = "Use TheFirst()";
        internal const string NewSyntax_UseTheLast = "Use TheLast()";
        internal const string NewSyntax_UseRandom = "Use Random()";
